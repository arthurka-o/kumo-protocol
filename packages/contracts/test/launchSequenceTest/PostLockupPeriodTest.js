...
contract("After the initial lockup period has passed", async accounts => {
  ...
  describe("Transferring KUMO", async accounts => {
    ...
    it("Anyone can increaseAllowance for any EOA or Kumo contract", async () => {
      ...
      const KUMOIncreaseAllowanceTx_3 = await kumoToken.increaseAllowance(multisig, dec(1, 18), {
        from: F
      });
    ...
    it("Anyone can decreaseAllowance for any EOA or Kumo contract", async () => {
      ...
      const KUMODecreaseAllowanceTx_3 = await kumoToken.decreaseAllowance(multisig, dec(1, 18), {
        from: F
      });
      ...
      for (const contract of Object.keys(KUMOContracts)) {
        const KUMOIncreaseAllowanceTx = await kumoToken.decreaseAllowance(
          KUMOContracts[contract].address,
          dec(1, 18),
          { from: F }
        );
    ...
    it("Anyone can be the sender in a transferFrom() call", async () => {
      ...
      const KUMOtransferFromTx_1 = await kumoToken.transferFrom(multisig, F, dec(1, 18), {
        from: F
      });
      const KUMOtransferFromTx_2 = await kumoToken.transferFrom(B, multisig, dec(1, 18), {
        from: G
      });
      const KUMOtransferFromTx_3 = await kumoToken.transferFrom(C, A, dec(1, 18), {
        from: multisig
      });
